//
//  ISAirnowCustomInterstitial-v7-2-0.swift
//  AirnowMediationWithIS
//
//  Created by Gusakovsky, Sergey on 15.02.22.
//
...
//MARK: - Use this interstitial adapter only for IronSource SDK 7.2.0+
@objc(ISAirnowCustomInterstitial)
public class ISAirnowCustomInterstitial: ISBaseInterstitial, AirMonetizationAdDelegate {

    @objc private var interstitialAd: AirMotetizationAd?

    @objc private weak var adapterDelegate: ISInterstitialAdDelegate? = nil

    @objc public override func loadAd(with adData: ISAdData, delegate: ISInterstitialAdDelegate) {
        guard
    ...
    @objc public override func showAd(with viewController: UIViewController, adData: ISAdData, delegate: ISInterstitialAdDelegate) {
    ...
    public func adDidFailWithError(ad: AirMotetizationAd, error: String) {
        ...
        adapterDelegate?.adDidFailToLoadWith(
            .internal,
            errorCode: ISAdapterErrors.internal.rawValue,
    ...
    public func adDidShowFailWithError(ad: AirMotetizationAd, error: String) {
        ...
        adapterDelegate?.adDidFailToShowWithErrorCode(
            ISAdapterErrors.missingParams.rawValue,
            errorMessage: ISAirMonetizationAdapterError.interstitialNotAvailable.description
        )
    }
